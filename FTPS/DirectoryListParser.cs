...
namespace FTPS.Common
{
    ...
    class DirectoryListParser
    {
        ...
        private static DirectoryListItem ParseDirectoryListItemFromWindowsStyleRecord(string record)
        {
            ...
            f.CreationTime = DateTime.Parse(dateStr + " " + timeStr, CultureInfo.CurrentCulture);
        ...
        private static DirectoryListItem ParseDirectoryListItemFromUnixStyleRecord(string record)
        {
            ...
            f.CreationTime = DateTime.ParseExact(creationTimeStr, dateFormat, CultureInfo.CurrentCulture, DateTimeStyles.AllowWhiteSpaces);
